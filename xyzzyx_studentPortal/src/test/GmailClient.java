...
//    private int receivingPort;
    ...
    public static void main(String[] args) {
        ...
        String mailFrom=new String("acedamymanager69@gmail.com");
 
        //Sender must be a Gmail Account holder
 
        String mailTo=new String("deepal.suranga29@gmail.com");
 
        //but here you can send to any type of mail account
 
        String senderPassword=new String("manager@admin");
 
        String senderUserName=new String("acedamymanager69@gmail.com");
